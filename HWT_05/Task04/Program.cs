...
namespace Task04
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("str2.EndWith('2') = {0}", str3.EndWith('2'));
            ...
            Console.WriteLine("str2.Remove(3) = {0}", str2.Remove(3));
            ...
            Console.WriteLine("str1.Substring(1, 3) = {0}", str1.Substring(1, 3));
